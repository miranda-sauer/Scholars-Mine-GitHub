...
def open_cannon_remake():
    ...
    cannon_remake.iconbitmap('R:/storage/libarchive/a/Scholars-Mine-GitHub/Control Panel/CODE/S&T_Logo.ico')
    ...
    def open_help():
        # Open word document
        try:
            os.startfile("R:/storage/libarchive/a/Scholars-Mine-GitHub/Control Panel/Documentation/Cannon Remake Help.docx")
        except:
